                        ...
                        <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                @foreach ($cart->items as $product)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p>
                                                Price :
                                                {{ App\Models\Currency::where('sign', $order->currency_sign)->first()->name }}{{ round($product['item_price'] * $order->currency_value, 2) }}
                                            </p>
                                            <p>
                                ...
                                <tr class="semi-border">
                                    ...
                                    <td>{{ App\Models\Currency::where('sign', $order->currency_sign)->first()->name }}{{ round($subtotal, 2) }}
                                    </td>
                                ...
                                @if ($order->shipping_cost != 0)
                                    <tr class="no-border">
                                        <td colspan="1"></td>
                                        <td><strong>{{ __('Shipping Cost') }}({{ App\Models\Currency::where('sign', $order->currency_sign)->first()->name }})</strong>
                                        </td>
                                ...
                                @if ($order->packing_cost != 0)
                                    <tr class="no-border">
                                        <td colspan="1"></td>
                                        <td><strong>{{ __('Packaging Cost') }}({{ App\Models\Currency::where('sign', $order->currency_sign)->first()->name }})</strong>
                                        </td>
                                ...
                                @if ($order->tax != 0)
                                    <tr class="no-border">
                                        <td colspan="1"></td>
                                        <td><strong>{{ __('TAX') }}({{ App\Models\Currency::where('sign', $order->currency_sign)->first()->name }})</strong>
                                        </td>
                                ...
                                @if ($order->coupon_discount != null)
                                    <tr class="no-border">
                                        <td colspan="1"></td>
                                        <td><strong>{{ __('Coupon Discount') }}({{ App\Models\Currency::where('sign', $order->currency_sign)->first()->name }})</strong>
                                        </td>
                                        <td>{{ App\Models\Currency::where('sign', $order->currency_sign)->first()->name }}{{ round($order->coupon_discount, 2) }}
                                        </td>
                                    </tr>
                                @endif
