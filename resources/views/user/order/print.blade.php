                                ...
                                <div class="row reorder-xs">
                                    <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                        <div class="product-header-title">
                                            <h2>{{ __('Order#') }} {{ $order->order_number }} [{{ $order->status }}]
                                            </h2>
                                        </div>
                                    </div>
                                    <div class="row">
                                                    ...
                                                    @else
                                                        <div class="invoice__metaInfo">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <p>{{ __('Tax') }}
                                                                    (<b>{{ $order->tax_location }}</b>) :
                                                                    {{ $order->currency_sign }}{{ $order->tax }}</p>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($cart['items'] as $product)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ mb_strlen($product['item']['name'], 'utf-8') > 25 ? mb_substr($product['item']['name'], 0, 25, 'utf-8') . '...' : $product['item']['name'] }}
                                                                        </td>
                                                                        <td>
                                                                            <b>{{ __('Quantity') }}</b>:
                                                                            {{ $product['qty'] }} <br>
