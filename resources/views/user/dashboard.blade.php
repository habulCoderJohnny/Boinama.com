              ...
              <div class="user-profile-details h100">
                <div class="account-info wallet h100">
                  ...
                  <div class="main-info">
                    ...
                    <h3 class="title w-price">{{ App\Models\Product::vendorConvertPrice($user->balance) }}</h3>
                    <a href="{{route('user-deposit-create')}}" class="mybtn1">{{__('Deposit')}}</a>
                  </div>
                  <hr>
                  <div class="main-info">
                    <h3 class="title w-title">{{ __('Reward Point') }}:</h3>
                    <h3 class="title w-price">{{$user->reward}}</h3>
                    <a href="{{route('user-reward-convernt')}}" class="mybtn1">{{__('Convert Point')}}</a>
                  </div>
                </div>
              </div>
            </div>
