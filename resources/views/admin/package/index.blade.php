                ...
                <div class="col-lg-12">
                    ...
                    <div class="heading-area">
                        ...
                        <div class="action-list">
                            <select
                                class="process select droplinks {{ $gs->multiple_packaging == 1 ? 'drop-success' : 'drop-danger' }}">
                                <option data-val="1" value="{{ route('admin-gs-mpackage', 1) }}"
                                    {{ $gs->multiple_packaging == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                <option data-val="0" value="{{ route('admin-gs-mpackage', 0) }}"
                                    {{ $gs->multiple_packaging == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                            </select>
                        </div>
                    </div>
