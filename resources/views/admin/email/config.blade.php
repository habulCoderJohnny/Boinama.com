                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                class="process select droplinks {{ $gs->is_smtp == 1 ? 'drop-success' : 'drop-danger' }}">
                                                <option data-val="1" value="{{ route('admin-gs-issmtp', 1) }}"
                                                    {{ $gs->is_smtp == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0" value="{{ route('admin-gs-issmtp', 0) }}"
                                                    {{ $gs->is_smtp == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="header_email" class="input-field" required>
                                            <option value="smtp" {{ $gs->header_email == 'smtp' ? 'selected' : '' }}>SMTP
                                            </option>
                                            <option value="sendmail"
                                                {{ $gs->header_email == 'sendmail' ? 'selected' : '' }}>SENDMAIL</option>
                                        </select>
