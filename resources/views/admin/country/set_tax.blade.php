...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"><u>{{ __($country->country_name) }}</u> / {{ __('Tax') }} <a class="add-btn"
                            href="{{ route('admin-country-tax') }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a>
                    </h4>
                    <ul class="links">
                        <li>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-tax-update', $country->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" name="tax" class="input-field"
                                            placeholder="{{ __('Enter Tax') }}" value="{{ $country->tax }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <ul class="list">
                                            <li>
                                                <input type="checkbox" name="is_state_tax" id="allow_state_tax"
                                                    value="1" id="check1">
                                ...
                                <div class="show_state d-none">
                                    <hr>
                                    <u>
                                        <h4 class="text-center mb-3">{{ $country->country_name }} / {{ __('State List') }}
                                        </h4>
                                    </u>
                                    <br>
                                    @forelse ($country->states as $state)
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" class="input-field" name="state_tax[]"
                                                    placeholder="Enter Tax" value="{{ $state->tax }}">
                                            </div>
                                        </div>
                                    @empty
                                        <div class="text-center">
                                            {{ __('State Not Found Please') }} <a class="mybtn1"
                                                href="{{ route('admin-state-index', $country->id) }}">{{ __('Insert State') }}</a>
                                        </div>
                                    @endforelse
                                </div>
