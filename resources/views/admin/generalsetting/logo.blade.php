                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box  bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
                            ...
                            @include('includes.admin.form-both')
                            <div class="currrent-logo">
                                <img src="{{ $gs->footer_logo ? asset('public/assets/images/' . $gs->footer_logo) : asset('public/assets/images/noimage.png') }}"
                                    alt="">
                            </div>
                            <div class="set-logo">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box  bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
                            ...
                            <div class="currrent-logo">
                                <img src="{{ $gs->invoice_logo ? asset('public/assets/images/' . $gs->invoice_logo) : asset('public/assets/images/noimage.png') }}"
                                    alt="">
                            </div>
