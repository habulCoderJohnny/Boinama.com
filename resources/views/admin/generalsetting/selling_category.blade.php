                            ...
                            <form id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="vendor_selling[]" value="physical"
                                                {{ in_array('physical', $vendor_sell_category) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="vendor_selling[]" value="digital"
                                                {{ in_array('digital', $vendor_sell_category) ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="vendor_selling[]" value="license"
                                                {{ in_array('license', $vendor_sell_category) ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
