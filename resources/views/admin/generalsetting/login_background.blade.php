                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-gs-update') }}" method="POST"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="img-upload full-width-img">
                                            <div id="image-preview" class="img-preview"
                                                style="background: url({{ $gs->login_background ? asset('public/assets/images/' . $gs->login_background) : asset('public/assets/images/noimage.png') }});">
                                                <label for="image-upload" class="img-label" id="image-label"><i
                                                        class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                                <input type="file" name="login_background" class="img-upload"
                                                    id="image-upload">
                                            </div>
                                        </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('Title') }}"
                                            name="login_title" value="{{ $gs->login_title }}" required="">
                                    </div>
                                </div>
