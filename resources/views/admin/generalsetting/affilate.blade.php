                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                class="process select droplinks {{ $gs->is_affilate == 1 ? 'drop-success' : 'drop-danger' }}">
                                                <option data-val="1" value="{{ route('admin-gs-isaffilate', 1) }}"
                                                    {{ $gs->is_affilate == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0" value="{{ route('admin-gs-isaffilate', 0) }}"
                                                    {{ $gs->is_affilate == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field"
                                            ...
                                            value="{{ $gs->affilate_charge }}" required="">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview"
                                                style="background: url({{ $gs->affilate_banner ? asset('public/assets/images/' . $gs->affilate_banner) : asset('public/assets/images/noimage.png') }});">
