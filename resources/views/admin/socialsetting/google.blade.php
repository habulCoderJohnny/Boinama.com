                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{ route('admin-social-googleup', 1) }}"
                                                    {{ $data->g_check == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0" value="{{ route('admin-social-googleup', 0) }}"
                                                    {{ $data->g_check == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            ...
                                            <p class="sub-heading">
                                                {{ __('Get Your Client ID from console.cloud.google.com') }}</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            ...
                                            <p class="sub-heading">
                                                {{ __('Get Your Client Secret from console.cloud.google.com') }}</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
