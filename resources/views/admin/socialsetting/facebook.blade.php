                                        ...
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1" value="{{ route('admin-social-facebookup', 1) }}"
                                                    {{ $data->f_check == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0" value="{{ route('admin-social-facebookup', 0) }}"
                                                    {{ $data->f_check == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            ...
                                            <p class="sub-heading">{{ __('Get Your App ID from developers.facebook.com') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            ...
                                            <p class="sub-heading">
                                                {{ __('Get Your App Secret from developers.facebook.com') }}</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            ...
                                            <p class="sub-heading">
                                                {{ __('Copy this url and paste it to your Valid OAuth Redirect URI in developers.facebook.com.') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
