        ...
        <div class="add-product-content1">
            <div class="product-description">
                <div class="body-area">
                    ...
                    <form id="geniusform" class="form-horizontal" action="{{ route('admin-social-update-all') }}"
                        method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="gplus" id="gplus"
                                    placeholder="{{ __('http://google.com/') }}" required="" type="text"
                                    value="{{ $data->gplus }}">
                            </div>
                            <div class="col-sm-3">
                                <label class="switch">
                                    <input type="checkbox" name="g_status" value="1"
                                        {{ $data->g_status == 1 ? 'checked' : '' }}>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <label class="switch">
                                    <input type="checkbox" name="d_status" value="1"
                                        {{ $data->d_status == 1 ? 'checked' : '' }}>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
