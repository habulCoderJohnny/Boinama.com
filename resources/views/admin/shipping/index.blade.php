                ...
                <div class="col-lg-12">
                    ...
                    <div class="heading-area">
                        ...
                        <div class="action-list">
                            <select
                                class="process select droplinks {{ $gs->multiple_shipping == 1 ? 'drop-success' : 'drop-danger' }}">
                                <option data-val="1" value="{{ route('admin-gs-mship', 1) }}"
                                    {{ $gs->multiple_shipping == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                <option data-val="0" value="{{ route('admin-gs-mship', 0) }}"
                                    {{ $gs->multiple_shipping == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                            </select>
                        </div>
                    </div>
