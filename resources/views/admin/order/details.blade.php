                                ...
                                <tbody>
                                    ...
                                    @if ($order->shipping_cost != 0)
                                        <tr>
                                            ...
                                            <td width="10%">:</td>
                                            <td width="45%">
                                                {{ round($order->shipping_cost, 2) }}{{ $order->currency_sign }}</td>
                                        </tr>
                                    @endif
                                    ...
                                    @if ($order->packing_cost != 0)
                                        <tr>
                                            ...
                                            <td width="10%">:</td>
                                            <td width="45%">
                                                {{ round($order->packing_cost, 2) }}{{ $order->currency_sign }}</td>
                                        </tr>
                                    @endif
                                    ...
                                    @if ($order->wallet_price != 0)
                                        <tr>
                                            ...
                                            <td width="10%">:</td>
                                            <td width="45%">
                                                {{ $order->currency_sign }}{{ round($order->wallet_price * $order->currency_value, 2) }}
                                            </td>
                                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">:</td>
                                        <td width="45%">
                                            {{ $order->currency_sign }}{{ $order->tax * $order->currency_value, 2 }}</td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    @if ($order->affilate_charge != null)
                                        <tr>
                                            ...
                                            @if ($gs->currency_format == 0)
                                                <td width="45%">
                                                    {{ $order->currency_sign }}{{ round($order->affilate_charge * $order->currency_value, 2) }}
                                                </td>
                                            @else
                                                <td width="45%">
                                                    {{ round($order->affilate_charge * $order->currency_value, 2) }}{{ $order->currency_sign }}
                                                </td>
                                            @endif
                                        </tr>
                                    @endif
