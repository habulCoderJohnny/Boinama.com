...
@section('styles')
    <link rel="stylesheet" href="{{ asset('public/assets/front/css/admin_cart.css') }}">
    <link rel="stylesheet" href="{{ asset('public/assets/front/css/admin_common.css') }}">
...
@section('content')
                ...
                <div class="col-lg-6">
                    <div class="special-box">
                        <div class="heading-area">
                            <h4 class="title">
                                {{ __('Billing Details') }}
                                <a href="javascript:;" data-toggle="modal" data-target="#select_customer" class="mybtn1"
                                    style="padding: 5px 12px;"><i class="fa fa-eye"></i> {{ __('Add Customer Info') }}</a>
                            </h4>
                        </div>
                            ...
                            <div class="body-area">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class=" form-control" id="prod_name_admin" name="search"
                                            placeholder="Search Product" value="" autocomplete="off">
    ...
    <span class="quick-view" rel-toggle="tooltip" href="javascript:;" data-href="" data-toggle="modal"
                                        ...
                                        <div class="body-area">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    ...
                                                    <button class="addProductSubmit-btn" id="new_user"
                                                        type="button">{{ __('New Customer') }}</button>
                                                </div>
                                            </div>
...
@section('scripts')
    <script src="{{ asset('public/assets/front/js/admin_custom.js') }}"></script>
