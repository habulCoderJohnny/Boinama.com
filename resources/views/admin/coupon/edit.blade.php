...
@section('content')
    <div class="content-area">
        ...
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Edit Coupon') }} <a class="add-btn" href="{{ route('admin-coupon-index') }}"><i
                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-coupon-update', $data->id) }}" method="POST"
                                    ...
                                    <div class="col-lg-7">
                                        <select name="category">
                                            ...
                                            @foreach ($categories as $cat)
                                                <option value="{{ $cat->id }}"
                                                    {{ $data->category == $cat->id ? 'selected' : '' }}>{{ $cat->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row hidden">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="number" class="input-field less-width" name="price" placeholder=""
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="end_date" id="to"
                                            autocomplete="off" placeholder="{{ __('Select a date') }}" required=""
                                            value="{{ $data->end_date }}">
                                    </div>
                                </div>
