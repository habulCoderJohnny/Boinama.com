                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="orders"
                                                {{ $data->sectionCheck('orders') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="products"
                                                {{ $data->sectionCheck('products') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="affilate_products"
                                                {{ $data->sectionCheck('affilate_products') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-2"></div>
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="customers"
                                                {{ $data->sectionCheck('customers') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="vendors"
                                                {{ $data->sectionCheck('vendors') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-2"></div>
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="vendor_subscription_plans"
                                                {{ $data->sectionCheck('vendor_subscription_plans') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="categories"
                                                {{ $data->sectionCheck('categories') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-2"></div>
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="bulk_product_upload"
                                                {{ $data->sectionCheck('bulk_product_upload') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="product_discussion"
                                                {{ $data->sectionCheck('product_discussion') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-2"></div>
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="set_coupons"
                                                {{ $data->sectionCheck('set_coupons') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="messages"
                                                {{ $data->sectionCheck('messages') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="menu_page_settings"
                                                {{ $data->sectionCheck('menu_page_settings') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-2"></div>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="payment_settings"
                                                {{ $data->sectionCheck('payment_settings') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-2"></div>
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="section[]" value="social_settings"
                                                {{ $data->sectionCheck('social_settings') ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
