                        ...
                        <div class="col-lg-12">
                            ...
                            <form id="geniusform" action="{{ route('admin-ps-homeupdate') }}" method="POST"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        <label class="control-label" for="featured_category">{{ __('Featured Category') }}
                                            *</label>
                                        <label class="switch">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        <label class="control-label" for="hot_sale">{{ __('Hot, New, Trending & Sale') }}
                                            *</label>
                                        <label class="switch">
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        <label class="control-label" for="review_blog">{{ __('Review & Blog') }}
                                            *</label>
                                        <label class="switch">
                                            <input type="checkbox" name="review_blog" value="1"
                                                {{ $data->review_blog == 1 ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
