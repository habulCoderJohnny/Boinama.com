                            ...
                            <form id="geniusform" action="{{ route('admin-ps-update') }}" method="POST"
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview"
                                                style="background: url({{ $data->best_seller_banner ? asset('public/assets/images/' . $data->best_seller_banner) : asset('public/assets/images/noimage.png') }});">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview"
                                                style="background: url({{ $data->best_seller_banner1 ? asset('public/assets/images/' . $data->best_seller_banner1) : asset('public/assets/images/noimage.png') }});">
                                                <label for="image-upload" class="img-label" id="image-label"><i
                                                        class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
