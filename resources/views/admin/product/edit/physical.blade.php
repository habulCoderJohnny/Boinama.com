                                    ...
                                    <div class="body-area">
                                            ...
                                            <div class="col-lg-12">
                                                @php
                                                    ...
                                                    foreach ($subCat as $sub) {
                                                        array_push($selectedSub, $sub->id);
                                                    }
                                                    foreach ($subChild as $child) {
                                                        array_push($selectedSub, $child->id);
                                                    }
                                                @endphp
                                        ...
                                        @if ($data->user_id > 0)
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <select id="vcrossselling" class="js-example-basic-multiple"
                                                        name="vcs_products[]" multiple="multiple">
                                                        @foreach ($vproducts as $vproduct)
                                                            <option value="{{ $vproduct->id }}">{{ $vproduct->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <select id="acrossselling" class="js-example-basic-multiple"
                                                    name="acs_products[]" multiple="multiple">
...
@section('scripts')
    <script>
        $('.js-example-basic-multiple').val(@php
            echo json_encode($selectedSub);
        @endphp).trigger('change');
    </script>
    <script>
