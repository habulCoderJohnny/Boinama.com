...
@if ($payment == 'authorize.net')
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <input class="form-control card-elements" name="cardCode" type="text"
                placeholder="{{ __('Enter Code') }}" autocomplete="off" />
        </div>
        <div class="col-lg-6">
            <input class="form-control card-elements" name="month" type="text"
                placeholder="{{ __('Month') }}" />
        </div>
        <div class="col-lg-6">
            <input class="form-control card-elements" name="year" type="text"
                placeholder="{{ __('Year') }}" />
        </div>
    </div>
@endif
...
@if ($payment == 'mercadopago')
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <input class="input-field" type="text" placeholder="{{ __('Credit Card Number') }}" id="cardNumber"
                data-checkout="cardNumber" onselectstart="return false" autocomplete=off required />
        </div>

        <div class="col-lg-6">
            <input class="input-field" type="text" id="securityCode" data-checkout="securityCode"
                placeholder="{{ __('Security Code') }}" onselectstart="return false" autocomplete=off required />
        </div>

        <div class="col-lg-6">
            <input class="input-field" type="text" id="cardExpirationMonth" data-checkout="cardExpirationMonth"
                placeholder="{{ __('Expiration Month') }}" autocomplete=off required />
        </div>

        <div class="col-lg-6">
            <input class="input-field" type="text" id="cardExpirationYear" data-checkout="cardExpirationYear"
                placeholder="{{ __('Expiration Year') }}" autocomplete=off required />
        </div>

        <div class="col-lg-6">
            <input class="input-field" type="text" id="cardholderName" data-checkout="cardholderName"
        ...
        <div class="col-lg-6">
            <input class="input-field" type="text" id="docNumber" data-checkout="docNumber"
