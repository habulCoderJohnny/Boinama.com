...
@section('styles')
    <link rel="stylesheet" href="{{ asset('public/assets/front/css/compaire.css') }}">
@endsection
@section('content')
                                            ...
                                            <tr>
                                                ...
                                                @foreach ($products as $product)
                                                    <td class="product-image-title c{{ $product['item']['id'] }}">
                                                        ...
                                                        <img class="img-fluid"
                                                            src="{{ $product['item']['thumbnail'] ? asset('public/assets/images/thumbnails/' . $product['item']['thumbnail']) : asset('public/assets/images/noimage.png') }}"
