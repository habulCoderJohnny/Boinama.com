    ...
    <section class="product-details-page">
                        ...
                        <div class="col-lg-7">
                            <div class="right-area">
                                <div class="product-info">
                                    ...
                                    <p><span>by</span> <a href="" class="text-info">{{ $writer }}</a></p>
                                    <div class="mb-3">
                                        <span style="font-weight:bold">Category:</span>
                                        <a href="" class="text-info">{{ $category }}</a>
                                    </div>
                                    ...
                                    <div class="product-price">
                                        ...
                                        <p class="price"><span
                                                id="sizeprice">{{ $productt->convertPrice($productt->vendorSizePrice()) }}</span>
                                        ...
                                        <ul>
                                            ...
                                            @if ($productt->type == 'License')
                                                ...
                                                @if ($productt->licence_type != null)
                                                    <li>
                                                        <p>{{ __('License Type') }}: <b>{{ $productt->licence_type }}</b>
                                                        </p>
                                                    </li>
                                                @endif
                                            @endif
                                                ...
                                                <li
                                                    ...
                                                    <div class="qty">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <span class="qttotal"
                                                                    data="{{ $productt->min_qty }}">{{ $productt->min_qty }}</span>
                                                            </li>
                                                            <li>
                                                                <span class="qtplus">
                                                                                ...
                                                                                <div class="custom-control custom-radio">
                                                                                    ...
                                                                                    <label class="custom-control-label"
                                                                                        ...
                                                                                        @if (!empty($attrVal['prices'][$optionKey]))
                                                                                            +
                                                                                            {{ $curr->sign }}
                                                                                            {{ round($attrVal['prices'][$optionKey] * $curr->value, 2) }}
                                                                                        @endif
                                                                                    </label>
                                                                                </div>
                                                                            @endforeach
                                                ...
                                                @else
                                                    @if ($productt->cross_selling_products()->count() + $countCsProds > 0)
                                                        <span class="hidden-add-to-cart"
                                                            ...
                                                            rel1="" rel=""></span>
                                                        <span class="crosssell-btn crosssell-view"
                                                            data-cs_href="{{ route('product.cross-sell', $productt->id) }}">
                                                            <i class="icofont-cart"></i> {{ __('Add To Cart') }}
                                                        </span>
                                                        <li class="addtocart">
                                                            <a href="#" id="qaddcrt" data-toggle="modal"
                                                                data-target="#productModal" style="cursor: pointer;">
                                                                একটু পড়ে দেখুন
                                                            </a>
                                                        </li>
                                                    @else
                                                        <li class="addtocart">
                                                            <a href="javascript:;" id="addcrt"><i
                                                                    class="icofont-cart"></i>{{ __('Add to Cart') }}</a>
                                                        </li>

                                                        <li class="addtocart">
                                                            <a id="qaddcrt" data-toggle="modal"
                                                                data-target="#productModal" style="cursor: pointer;">
                                                                একটু পড়ে দেখুন
                                                            </a>
                                                        </li>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <embed src="{{ url('assets/files', $productt->pdf) }}"
                        ...
                        <div class="col-lg-12">
                            <div id="product-details-tab">
                                <div class="top-menu-area">
                                    <ul class="tab-menu">
                                        ...
                                        <li style="display:none"><a
                                                href="#tabs-3">{{ __('Reviews') }}({{ count($productt->ratings) }})</a>
                                        </li>
                                        @if ($productt->specification)
                                            <li style=""><a href="#tabs-5">{{ __('Specification') }}</a></li>
                                        @endif
                                        @if ($gs->is_comment == 1)
                                            <li style="display:none"><a href="#tabs-4">{{ __('Comment') }}(<span
                                ...
                                <div class="tab-content-wrapper">
                                    ...
                                    <div id="tabs-3" class="tab-content-area" style="display:none">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <h5 class="text-center"><a href="javascript:;"
                                                                ...
                                                                class="btn login-btn mr-1">{{ __('Login') }}</a>
                                                            {{ __('To Review') }}</h5>
                                                        <br>
                                                    </div>
                                                </div>
        ...
        <div class="trending">
            <div class="container-fluid">
                ...
                <div class="row trending-item-slider">
