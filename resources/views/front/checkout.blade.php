                                        ...
                                        <div class="content">
                                                    ...
                                                    @if (!$address)
                                                        ...
                                                        <div class="col-lg-6">
                                                            <select class="form-control" id="select_division"
                                                                name="customer_division" required="">
                                                                <option value="">Select Division</option>
                                                                @foreach ($divisions as $division)
                                                                    <option value="{{ $division->name }}"
                                                                        data="{{ $division->id }}"
                                                                        data-href="{{ route('divison.wise.district', $division->id) }}">
                                                        ...
                                                        <div class="col-lg-6 mb-2">
                                                            <select class="form-control d-none" id="select_district"
                                                                name="customer_district" required="">
                                                            </select>
                                                        </div>
                                                        <div class="col-lg-6 mb-2">
                                                            <select class="form-control d-none" id="select_upazila"
                                                                name="customer_upazila" required="">
                                                            </select>
                                                        </div>
                                                    @else
                                                        <div class="col-lg-12 my-4">
                                                            <div class="jumbotron" style="padding:10px 20px;">
                                                                <p class="">Deliver to: {{ $address->name }}</p>
                                                                <p>{{ $address->mobile }} |
                                                                    {{ $address->address }},
                                            ...
                                            <div class="ship-diff-addres-area d-none">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="form-control" id="select_division"
                                                            name="shipping_division" required="">
                                                            <option value="">Select Division</option>
                                                            @foreach ($divisions as $division)
                                                                <option value="{{ $division->name }}"
                                                                    data="{{ $division->id }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 mb-2">
                                                        <select class="form-control d-none" id="select_district"
                                                            name="shipping_district" required="">
                                                        </select>
                                                    </div>
                                                    <div class="col-lg-6 mb-2">
                                                        <select class="form-control d-none" id="select_upazila"
                                                            name="shipping_upazila" required="">
                                                        </select>
                                                    </div>
                                                ...
                                                @foreach ($products as $product)
                                                    @php
                                                        if (isset($product['discount1'])) {
                                                            $discount_whole_sell += $product['discount1'];
                                                        }
                                                    @endphp
                            ...
                            <div class="order-box">
                                ...
                                <ul class="order-list">
                                    <li>
                                        ...
                                        <P>
                                            <b
                                                class="cart-total">{{ Session::has('cart') ? App\Models\Product::convertPrice(Session::get('cart')->totalPrice + $discount_whole_sell) : '0.00' }}</b>
                                        </P>
                                    </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('checkout.address.update', $address->id) }}" method="post">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title mt-3" id="addressModalTitle">Edit Address</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6 my-2">
                                <input class="form-control" type="text" name="name"
                                    placeholder="{{ __('Full Name') }}" required="" value="{{ $address->name }}">
                            </div>
                            <div class="col-lg-6 my-2">
                                <input class="form-control" type="text" name="phone"
                                    placeholder="{{ __('Phone Number') }}" required=""
                            ...
                            <div class="col-lg-6 my-2">
                                <input class="form-control" type="text" name="email"
                                    placeholder="{{ __('Email') }}" required="" value="{{ $address->email }}">
                            </div>
                            <div class="col-lg-6 my-2">
                                <input class="form-control" type="text" name="address"
                                    placeholder="{{ __('Address') }}" required="" value="{{ $address->address }}">
                            </div>
                            <div class="col-lg-6 my-2">
                                <select class="form-control" id="select_division" name="customer_division"
                                    required="">
                                    <option value="">Select Division</option>
                                    @foreach ($divisions as $division)
                                        <option value="{{ $division->name }}" data="{{ $division->id }}"
                                            data-href="{{ route('divison.wise.district', $division->id) }}">
                                            {{ $division->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-6 my-2 ">
                                <select class="form-control d-none" id="select_district" name="customer_district"
                                    required="">
                                </select>
                            </div>
                            <div class="col-lg-6 my-2">
                                <select class="form-control d-none" id="select_upazila" name="customer_upazila"
                                    required="">
                                </select>
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '#select_division', function() {
            ...
            const route = $('#select_division option:selected').attr('data-href');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    districtsSelect.removeClass("d-none")
                    districtsSelect.append(response.data);
                },
        ...
        $(document).on('change', '#select_district', function() {
            const route = $('#select_district option:selected').attr('data-href');
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function(response) {
                    var selectUpazila = $('#select_upazila');
                    selectUpazila.empty();
                    selectUpazila.removeClass("d-none");
                    selectUpazila.append(response.data);
                },
                error: function(xhr, status, error) {
                    console.error(xhr.responseText);
                }
