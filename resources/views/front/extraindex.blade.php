        ...
        <div class="row">
            <div class="col-lg-12" style="padding:0px;">
                <div class="banner-inner-area">
                    ...
                    <!--		<div class="img lazy" data-src="{{ $ps->gallery_large_banner ? asset('public/assets/images/' . $ps->gallery_large_banner) : asset('public/assets/images/noimage.png') }}" ></div>-->
                    ...
                    <div class="right-banner">
                        <div class="mycol c1">
                            <a href="{{ $ps->gallery_small_banner_link1 }}" class="banner">
                                <div class="img lazy"
                                    data-src="{{ $ps->gallery_small_banner1 ? asset('public/assets/images/' . $ps->gallery_small_banner1) : asset('public/assets/images/noimage.png') }}">
                                </div>
                            </a>
                        </div>
                        <div class="mycol c2">
                            <a href="{{ $ps->gallery_small_banner_link2 }}" class="banner">
                                <div class="img lazy"
                                    data-src="{{ $ps->gallery_small_banner2 ? asset('public/assets/images/' . $ps->gallery_small_banner2) : asset('public/assets/images/noimage.png') }}">
                                </div>
                            </a>
                        </div>
                        <div class="mycol c3">
                            <a href="{{ $ps->gallery_small_banner_link3 }}" class="banner">
                                <div class="img lazy"
                                    data-src="{{ $ps->gallery_small_banner3 ? asset('public/assets/images/' . $ps->gallery_small_banner3) : asset('public/assets/images/noimage.png') }}">
                                </div>
                        ...
                        <div class="mycol">
                            <a href="{{ $ps->gallery_small_banner_link4 }}" class="banner">
                                <div class="img lazy"
                                    data-src="{{ $ps->gallery_small_banner4 ? asset('public/assets/images/' . $ps->gallery_small_banner4) : asset('public/assets/images/noimage.png lazy') }}">
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="left">
                                <a class="banner-effect" href="{{ $img->link }}" target="_blank">
                                    <img class="lazy"
                                        data-src="{{ asset('public/assets/images/banners/' . $img->photo) }}"
                                        alt="">
                                </a>
                            </div>
                        </div>
...
@endforeach-->
    ...
    <!--			<img class="lazy" data-src="{{ asset('public/assets/images/' . $ps->best_seller_banner) }}" alt="">-->
    <!--		</a>-->
    <!--		<a class="banner-effect" href="{{ $ps->best_seller_banner_link1 }}">-->
    <!--			<img class="lazy" data-src="{{ asset('public/assets/images/' . $ps->best_seller_banner1) }}" alt="">-->
    <!--		</a>-->
    <!--	</div>-->
    <!--</div>-->
    <!--		</div>-->
...
@endforeach-->
    ...
    <!--						<img class="lazy" data-src="{{ asset('public/assets/images/' . $ps->big_save_banner) }}" alt="">-->
    <!--					</a>-->
    <!--					<a class="banner-effect" href="{{ $ps->big_save_banner_link1 }}">-->
    <!--						<img class="lazy" data-src="{{ asset('public/assets/images/' . $ps->big_save_banner1) }}" alt="">-->
    <!--					</a>-->
    <!--				</div>-->
    <!--			</div>-->
    <!--		</div>-->
...
<!--                            <div class="slide-item">-->
<!--                                <div class="top-area">-->
<!--                                        <img class="lazy" data-src="{{ $review->photo ? asset('public/assets/images/reviews/' . $review->photo) : asset('public/assets/images/noimage.png') }}" alt="">-->
<!--                                </div>-->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-box">
                            <div class="blog-images">
                                <div class="img">
                                    <img data-src="{{ $blogg->photo ? asset('public/assets/images/blogs/' . $blogg->photo) : asset('public/assets/images/noimage.png') }}"
                        ...
                        @foreach ($partners as $data)
                            <div class="item-slide">
                                <a href="{{ $data->link }}" target="_blank">
                                    <img class="lazy"
                                        data-src="{{ asset('public/assets/images/partner/' . $data->photo) }}"
                                        alt="">
                                </a>
                            </div>
                        @endforeach
...
@if ($ps->service == 1)
    ...
    <!--      <div class="row">-->
    <!--        <div class="col-lg-12">-->
    <!--          <div class="subscriber-area"  style="background-image: url({{ asset('public/assets/images/' . $gs->newsletter_banner) }})">-->
                        ...
                        <div class="row">
                            ...
                            @foreach ($services as $service)
                                <div class="col-6 col-xl-3 p-0">
                                    <div class="info-box">
                                        <div class="icon">
                                            <img class="lazy-service"
                                                data-src="{{ asset('public/assets/images/services/' . $service->photo) }}">
                                        </div>
                                        <div class="info">
                                            <div class="details">
