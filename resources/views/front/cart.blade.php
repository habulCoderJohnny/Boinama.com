...
@section('styles')
    <link rel="stylesheet" href="{{ asset('public/assets/front/css/cart.css') }}">
@endsection
@section('content')
                                        ...
                                        @foreach ($products as $product)
                                            ...
                                            <tr
                                                ...
                                                <td class="product-img">
                                                    <div class="item">
                                                        <img src="{{ $product['item']['photo'] ? asset('public/assets/images/products/' . $product['item']['photo']) : asset('public/assets/images/noimage.png') }}"
                                                            alt="">
                                                        <p class="name"><a
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <span class="qttotal1"
                                                                        ...
                                                                        data="{{ $product['item']['min_qty'] }}">{{ $product['qty'] }}</span>
                                                                </li>
                                                                <li>
                                                ...
                                                <td class="total-price">
                                                    ...
                                                    @endphp
                                                    <small
                                                        id="prev{{ $product['item']['id'] . $product['size'] . $product['color'] . str_replace(str_split(' ,'), '', $product['values']) }}"
                                                        class="{{ Session::has('current_discount' . $product['item']['id'] . $product['size'] . $product['color'] . str_replace(str_split(' ,'), '', $product['values'])) && isset(Session::get('current_discount' . $product['item']['id'] . $product['size'] . $product['color'] . str_replace(str_split(' ,'), '', $product['values']))[$product['item']['id'] . $product['size'] . $product['color'] . str_replace(str_split(' ,'), '', $product['values'])]) ? '' : 'd-none' }}">(Discount
                                                        <small
                            ...
                            <div class="order-box">
                                ...
                                <ul class="order-list">
                                    <li>
                                        ...
                                        <P>
                                            <b
                                                class="cart-total">{{ Session::has('cart') ? App\Models\Product::convertPrice($totalPrice + $discount) : '0.00' }}</b>
                                        </P>
                                    </li>
