...
class Product extends Model
{
    ...
    {
        return $this->belongsToMany(Childcategory::class, 'product_child_categories', 'product_id', 'childcategory_id');
    }
