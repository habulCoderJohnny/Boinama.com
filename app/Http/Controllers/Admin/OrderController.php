...
class OrderController extends Controller
{
    ...
    {
        if ($status == 'pending') {
            $datas = Order::where('status', '=', 'pending')->select('id', 'pay_amount', 'order_number', 'currency_sign', 'currency_value', 'customer_email', 'totalQty');
        } elseif ($status == 'processing') {
            $datas = Order::where('status', '=', 'processing')->select('id', 'pay_amount', 'order_number', 'currency_sign', 'currency_value', 'customer_email', 'totalQty');
        } elseif ($status == 'completed') {
            $datas = Order::where('status', '=', 'completed')->select('id', 'pay_amount', 'order_number', 'currency_sign', 'currency_value', 'customer_email', 'totalQty');
        } elseif ($status == 'declined') {
            $datas = Order::where('status', '=', 'declined')->select('id', 'pay_amount', 'order_number', 'currency_sign', 'currency_value', 'customer_email', 'totalQty');
        } else {
            $datas = Order::orderBy('id', 'desc')->select('id', 'pay_amount', 'order_number', 'currency_sign', 'currency_value', 'customer_email', 'totalQty');
        }
