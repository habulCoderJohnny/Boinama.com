...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/all/notf/count', [NotificationController::class, 'all_notf_count'])->name('all-notf-count');
    ...
    Route::get('/country/datatables', [CountryController::class, 'datatables'])->name('admin-country-datatables');
    Route::get('/manage/country', [CountryController::class, 'manageCountry'])->name('admin-country-index');
    Route::get('/country/status/{id1}/{id2}', [CountryController::class, 'status'])->name('admin-country-status');
    Route::get('/country/delete/{id}', [CountryController::class, 'delete'])->name('admin-country-delete');
    Route::get('/country/tax/datatables', [CountryController::class, 'taxDatatables'])->name('admin-country-tax-datatables');
    Route::get('/manage/country/tax', [CountryController::class, 'country_tax'])->name('admin-country-tax');
    ...
    Route::group(['middleware' => 'permissions:orders'], function () {
        ...
        Route::get('/orders/datatables/{slug}', [OrderController::class, 'datatables'])->name('admin-order-datatables');
        ...
        Route::get('/orders/refund/datatables', [OrderController::class, 'refundDatatables'])->name('admin-refund-order-datatables');
        Route::get('/orders/refund/request', [OrderController::class, 'refundIndex'])->name('admin-order-refund');
        Route::get('/orders/refund/request/accept/{id}', [OrderController::class, 'refundAccept'])->name('admin-refund-accept');
        Route::get('/orders/refund/request/reject/{id}', [OrderController::class, 'refundReject'])->name('admin-refund-reject');
    ...
    Route::group(['middleware' => 'permissions:products'], function () {
        ...
        Route::get('/products/datatables', [ProductController::class, 'datatables'])->name('admin-prod-datatables');
        ...
        Route::get('/products/deactive/datatables', [ProductController::class, 'deactivedatatables'])->name('admin-prod-deactive-datatables');
        Route::get('/products/deactive', [ProductController::class, 'deactive'])->name('admin-prod-deactive');

        Route::get('/products/catalogs/datatables', [ProductController::class, 'catalogdatatables'])->name('admin-prod-catalog-datatables');
    ...
    Route::group(['middleware' => 'permissions:affilate_products'], function () {
        ...
        Route::get('/products/import/datatables', [ImportController::class, 'datatables'])->name('admin-import-datatables');
    ...
    Route::group(['middleware' => 'permissions:customers'], function () {
        ...
        Route::get('/users/reward/{id}', [UserController::class, 'reward'])->name('admin-user-reward');
        Route::post('/user/reward/{id}', [UserController::class, 'rewardUpdate'])->name('admin-user-reward-update');
    ...
    Route::get('/verificatons/datatables/{status}', [VerificationController::class, 'datatables'])->name('admin-vr-datatables');
    Route::get('/verificatons', [VerificationController::class, 'index'])->name('admin-vr-index');
    Route::get('/verificatons/pendings', [VerificationController::class, 'pending'])->name('admin-vr-pending');

    Route::get('/verificatons/show', [VerificationController::class, 'show'])->name('admin-vr-show');
    Route::get('/verificatons/edit/{id}', [VerificationController::class, 'edit'])->name('admin-vr-edit');
    Route::post('/verificatons/edit/{id}', [VerificationController::class, 'update'])->name('admin-vr-update');
    Route::get('/verificatons/status/{id1}/{id2}', [VerificationController::class, 'status'])->name('admin-vr-st');
    Route::get('/verificatons/delete/{id}', [VerificationController::class, 'destroy'])->name('admin-vr-delete');
    ...
    Route::group(['middleware' => 'permissions:categories'], function () {
        ...
        Route::post("load/child-categories", [ChildCategoryController::class, 'loadChildCategories'])->name('admin-childcat-loadChildCategories');
    ...
    Route::group(['middleware' => 'permissions:payment_settings'], function () {
        ...
        Route::get('/paymentgateway/status/{id1}/{id2}/{id3}', [PaymentGatewayController::class, 'status'])->name('admin-payment-status');
...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    Route::group(['middleware' => 'HtmlMinifier'], function () {
        ...
        Route::group(["middleware" => "auth"], function () {
            ...
            Route::get('/division/wise/districts/{division_id}', 'Front\CheckoutController@getDistrict')->name('divison.wise.district');
            Route::get('/district/wise/upazilas/{district_id}', 'Front\CheckoutController@getUpazila')->name('district.wise.upazilas');
            ...
            Route::post("/checkout/address/update/{id}",[CheckoutController::class,'addressUpdate'])->name('checkout.address.update');
